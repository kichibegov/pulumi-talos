...
import (
	...
	"github.com/kichibegov/pulumi-talos/provider/pkg/version"
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-talos/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-talos/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "talos", talos.Provider(),
		...
		// convention is to have a function at "github.com/siderolabs/terraform-provider-talos/provider".New
		...
		PluginDownloadURL: "github://api.github.com/kichibegov/pulumi-talos",
		Description:       "A Pulumi package for creating and managing talos cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"talos", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/kichibegov/pulumi-talos",
		...
		//	"region": {
		//		Type: "talos:region/region:Region",
		//	},
		//},
		// If extra types are needed for configuration, they can be added here.
		Resources: map[string]*tfbridge.ResourceInfo{
			"talos_machine_bootstrap": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "MachineBootstrap"),
				Docs: &tfbridge.DocInfo{
					ImportDetails: "Machine bootstrap can be imported to let Pulumi know that the machine is already bootstrapped",
				},
			},
			"talos_machine_secrets": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "MachineSecrets"),
				Docs: &tfbridge.DocInfo{
					ImportDetails: "Machine secrets can be imported from an existing secrets file",
				},
			},
			// Добавьте другие ресурсы по аналогии при необходимости
		},
		ExtraTypes: map[string]schema.ComplexTypeSpec{
			"talos:region/region:Region": {
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/kichibegov/pulumi-talos/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("talos_", mainMod,
